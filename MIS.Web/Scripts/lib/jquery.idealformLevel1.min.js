                    ...
                    var self = this,
                        ...
                        item = function (val) {
                            ...
                            if (val == 5)
                                tabName = 'Promotions';
                            if (val == 6)
                                tabName = 'Final Submit';
                            var id = ("Tab" + val).replace(/ /g, '');
                            return '<li id="' + id + '" class="tabClass"><a href="javascript:void(0)" tabindex="-1">' + tabName + '</a></li>';
                        },
                        items;
