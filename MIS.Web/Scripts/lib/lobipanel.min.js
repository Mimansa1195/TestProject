    ...
    var LobiPanel = function ($el, options) {
        ...
        var $heading, $body, innerId, storagePrefix = "lobipanel_",
            ...
            _processInput = function (options) {
                ...
                for (var objects = ["unpin", "expand", "minimize", "close"], i = 0; i < objects.length; i++) {
                    var prop = objects[i];
            ...
            _generateControls = function () {
                ...
                return me.$options.minimize !== !1 && menu.append(_generateMinimize()), me.$options.expand !== !1 && menu.append(_generateExpand()), menu.find(">li>a").on("click", function (ev) {   //me.$options.unpin !== !1 && menu.append(_generateUnpin()),, me.$options.close !== !1 && menu.append(_generateClose())
