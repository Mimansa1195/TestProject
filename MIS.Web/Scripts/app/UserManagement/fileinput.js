...
!function (e) {
    ...
    t = {
        ...
        getDragDropFolders: function (e) {
            var t, i, a = e.length, r = 0;
            if (a > 0 && e[0].webkitGetAsEntry())
                for (t = 0; a > t; t++)
                    i = e[t].webkitGetAsEntry(),
                        i && i.isDirectory && r++;
            return r
        },
        ...
        i.prototype = {
            ...
            _init: function (i, a) {
                ...
                s.options = i,
                    ...
                    a ? s._errorsExist() || s.$errorContainer.hide() : (s.$errorContainer.hide(),
                ...
                i.previewCache = {
                    ...
                    footer: function (e, a, r) {
                        ...
                        (t.isEmpty(n.config) || t.isEmpty(n.config[e])) && (n.config[e] = {}),
                            a = void 0 === a ? !0 : a;
                        var o, l = n.config[e], s = t.ifSet("caption", l), d = t.ifSet("width", l, "auto"), c = t.ifSet("url", l, !1), p = t.ifSet("key", l, null), u = i.fileActionSettings, f = i.initialPreviewShowDelete || !1, m = l.downloadUrl || i.initialPreviewDownloadUrl || "", v = l.filename || l.caption || "", g = !!m, h = t.ifSet("showRemove", l, t.ifSet("showRemove", u, f)), w = t.ifSet("showDownload", l, t.ifSet("showDownload", u, g)), _ = t.ifSet("showZoom", l, t.ifSet("showZoom", u, !0)), b = t.ifSet("showDrag", l, t.ifSet("showDrag", u, !0)), C = c === !1 && a;
            ...
            _scanDroppedItems: function (e, t, i) {
                ...
                e.isFile ? e.file(function (e) {
                    t.push(e)
                }, l) : e.isDirectory && (r = e.createReader(),
                    (n = function () {
            ...
            _initDragDrop: function () {
                var t = this
                    , i = t.$dropZone;
                t.dropZoneEnabled && t.showPreview && (t._handler(i, "dragenter dragover", e.proxy(t._zoneDragEnter, t)),
            ...
            _zoneDrop: function (e) {
                var i, a = this, r = a.$element, n = e.originalEvent.dataTransfer, o = n.files, l = n.items, s = t.getDragDropFolders(l), d = function () {
                    a.isAjaxUpload ? a._change(e, o) : (a.changeTriggered = !0,
                        r.get(0).files = o,
                        setTimeout(function () {
                            a.changeTriggered = !1,
                ...
                if (e.preventDefault(),
                    !a.isDisabled && !t.isEmpty(o))
                    if (s > 0) {
                        if (!a.isAjaxUpload)
                            return void a._showFolderError(s);
                        for (o = [],
                            i = 0; i < l.length; i++) {
            ...
            _refreshPreview: function () {
                var e, t = this;
                t._inputFileCount() && t.showPreview && t.isPreviewable && (t.isAjaxUpload ? (e = t.getFileStack(),
                    t.filestack = [],
                    e.length ? t._clearFileInput() : e = t.$element.get(0).files) : e = t.$element.get(0).files,
                    e && e.length && (t.readFiles(e),
            ...
            _clearFileInput: function () {
                ...
                r._inputFileCount() && (t = n.closest("form"),
            ...
            _mergeAjaxCallback: function (e, t, i) {
                ...
                "delete" === i && (n = r._ajaxDeleteSettings,
            ...
            _deleteFileIndex: function (i) {
                ...
                "init_" === r.substring(0, 5) && (r = parseInt(r.replace("init_", "")),
                    ...
                    a.initialPreviewConfig = t.spliceArray(a.initialPreviewConfig, r, n),
                    a.initialPreviewThumbTags = t.spliceArray(a.initialPreviewThumbTags, r, n),
            ...
            _setFileDropZoneTitle: function () {
                ...
                i.isClickable && (e = t.isEmpty(i.$element.attr("multiple")) ? i.fileSingle : i.filePlural,
                    ...
                    !i.showPreview || 0 === a.length || i.getFileStack().length > 0 || !i.dropZoneEnabled || !i.isAjaxUpload && i.$element.files || (0 === a.find(t.FRAMES).length && t.isEmpty(i.defaultPreviewContent) && a.prepend('<div class="' + i.dropZoneTitleClass + '">' + r + "</div>"),
            ...
            _initBrowse: function (e) {
                var i = this
                    , a = i.$element;
                i.showBrowse ? i.$btnFile = e.find(".btn-file").append(a) : (a.appendTo(e).attr("tabindex", -1),
            ...
            _initClickable: function () {
                ...
                a.isClickable && (i = a.isAjaxUpload ? a.$dropZone : a.$preview.find(".file-default-preview"),
                    ...
                    a._handler(i, "click", function (t) {
                        var r = e(t.target);
                        a.$element;
                        e(a.elErrorContainer + ":visible").length || r.parents(".file-preview-thumbnails").length && !r.parents(".file-default-preview").length || (a.$element.data("zoneClicked", !0).trigger("click"),
                            i.blur())
                    }))
            },
            ...
            _change: function (i) {
                ...
                if (!a.changeTriggered) {
                    var r, n, o = a.$element, l = arguments.length > 1, s = a.isAjaxUpload, d = [], c = l ? arguments[1] : o.get(0).files, p = !s && t.isEmpty(o.attr("multiple")) ? 1 : a.maxFileCount, u = a.filestack.length, f = t.isEmpty(o.attr("multiple")), m = f && u > 0, v = a._getFileIds(), g = function (t, i, r, n) {
                    ...
                    if (a.reader = null,
                        a._resetUpload(),
                        a._hideFileIcon(),
                        a.dropZoneEnabled && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(),
                        s ? e.each(c, function (e, t) {
                    ...
                    if (a._resetErrors(),
                        n = d.length,
                        r = a._getFileCount(s ? a.getFileStack().length + n : n),
                        p > 0 && r > p) {
                        if (!a.autoReplace || n > p)
                            return void h(a.autoReplace && n > p ? n : r, p);
                        r > p && a._resetPreviewThumbs(s)
                    } else
                        !s || m ? (a._resetPreviewThumbs(!1),
                            m && a.clearStack()) : !s || 0 !== u || a.previewCache.count() && !a.overwriteInitial || a._resetPreviewThumbs(!0);
            ...
            _resetFileStack: function () {
                ...
                i._getThumbs().each(function () {
                    var l = e(this)
                        ...
                        , d = i.filestack[s]
                        , c = l.attr("id");
                    "-1" !== s && -1 !== s && (void 0 !== d ? (r[a] = d,
                        n[a] = i._getFileName(d),
                        o[a] = i._getFileId(d),
                        l.attr({
                    ...
                    a = function (x) {
                        if (t.isEmpty(n.attr("multiple")) && (f = 1),
                            ...
                            return r.isAjaxUpload && r.filestack.length > 0 ? r._raise("filebatchselected", [r.getFileStack()]) : r._raise("filebatchselected", [i]),
                                s.removeClass("file-thumb-loading"),
                                void d.html("");
                        var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, B = u + "-" + U, O = i[x], R = m.text, L = m.image, Z = m.html, M = O && O.name ? r.slug(O.name) : "", N = (O && O.size || 0) / 1e3, H = "", V = O ? t.objUrl.createObjectURL(O) : null, W = 0, q = "", K = 0, G = function () {
                            var e = p.setTokens({
                                index: x + 1,
                                files: f,
                                percent: 50,
                        ...
                        if (O) {
                            ...
                            if (M === !1)
                                return void a(x + 1);
                            if (0 === M.length)
                                return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(O.name)),
                                    void y(S, O, B, x);
                            ...
                            if (0 === W && !t.isEmpty(w) && t.isArray(w) && !t.isEmpty(H) && (F = t.compare(M, H),
                                W += t.isEmpty(F) ? 0 : F.length,
                                0 === W))
                                return S = r.msgInvalidFileExtension.setTokens({
                                    name: M,
                                    extensions: _
                                }),
                                    void y(S, O, B, x);
                            if (!r.showPreview)
                                return r.isAjaxUpload && r.addToStack(O),
                                    setTimeout(function () {
                                        a(x + 1),
                                            r._updateFileDetails(f)
                                    }, 100),
                            ...
                            if (!C && N > b)
                                return r.addToStack(O),
                                    s.addClass("file-thumb-loading"),
                                    r._previewDefault(O, B),
                                    r._initFileActions(),
                                    r._updateFileDetails(f),
                                    void a(x + 1);
                            o.length && void 0 !== FileReader ? (D = R(O.type, M),
                                z = Z(O.type, M),
                                $ = L(O.type, M),
                                    ...
                                    if (n = {
                                        ...
                                        if (a = p.join("").toLowerCase().substring(0, 8),
                                            ...
                                            t.isEmpty(c) && (d = t.arrayBuffer2String(l.result),
                                                c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, O.type)),
                                            n = {
                                                name: M,
                                                type: c
                                            },
                                ...
                                ,
                                D || z ? l.readAsText(O, r.textEncoding) : $ ? l.readAsDataURL(O) : l.readAsArrayBuffer(O)) : (r._previewDefault(O, B),
                                    setTimeout(function () {
                                        a(x + 1),
                                            r._updateFileDetails(f)
                                    }, 100),
            ...
            refresh: function (i) {
                var a = this
                    , r = a.$element;
                return i = "object" != typeof i || t.isEmpty(i) ? a.options : e.extend(!0, {}, a.options, i),
                    a._init(i, !0),
                    a._listen(),
                    r
            },
